...
const SAFE_LEFT_PERCENT = 8
const SAFE_RIGHT_PERCENT = 92
const SAFE_TOP_PERCENT = 10
const SAFE_BOTTOM_PERCENT = 88

const TABLE_CENTER_X_PERCENT = 50
const TABLE_CENTER_Y_PERCENT = 58
const TABLE_SEAT_RADIUS_X_PERCENT = 38
const TABLE_SEAT_RADIUS_Y_PERCENT = 34
