...
const SAFE_LEFT_PERCENT = 12
const SAFE_RIGHT_PERCENT = 88
const SAFE_TOP_PERCENT = 16
const SAFE_BOTTOM_PERCENT = 84

const TABLE_CENTER_X_PERCENT = 50
const TABLE_CENTER_Y_PERCENT = 56
const TABLE_SEAT_RADIUS_X_PERCENT = 44
const TABLE_SEAT_RADIUS_Y_PERCENT = 32
const LABEL_RADIUS_X = TABLE_SEAT_RADIUS_X_PERCENT + 10
const LABEL_RADIUS_Y = TABLE_SEAT_RADIUS_Y_PERCENT + 8
