    ...
    <div className="rounded-2xl border border-[var(--border-2)] bg-[var(--surface-2)] p-5 text-center shadow-[0_12px_24px_rgba(0,0,0,0.2)]">
      ...
      {actionLabel && onAction && (
        <div className="mt-4 flex justify-center">
          ...
          >
            <span className="flex h-9 items-center rounded-full border border-[var(--border-2)] bg-[var(--surface-1)] px-4 text-[12px] font-semibold text-[var(--text-1)] transition group-active:scale-[0.97]">
              {actionLabel}
            </span>
          </button>
        </div>
